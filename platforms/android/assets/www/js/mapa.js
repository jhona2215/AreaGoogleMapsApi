...
function haversine(latitud,longitud){
  ...
  //6371 km
  //d = (2*6371)*Math.asin(Math.sqrt((Math.sin(-1*(latitud*Math.PI)/2)*Math.sin(-1*(latitud*Math.PI)/2))+(Math.cos(latitud*Math.PI)*Math.sin((Math.PI*latitud)/2)*Math.sin((Math.PI*latitud)/2))));
